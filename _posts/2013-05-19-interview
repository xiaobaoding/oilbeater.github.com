...
按惯例这一块会有长长的书单，先推荐基本我觉得一定要看的，后面会针对不同的要求再推荐基本。只推荐我看过的，因为我觉得推荐一堆我都没看过的书是件很没诚意的事情。
...
推荐这本书自我感觉就是件很没诚意的事情。个人对这本书的印象不太好，过于学术且理解起来很晦涩，不知道为啥这本书被捧上神探。推荐的读法是把他当算法词典，把算法的思想看一遍，至于证明和推理什么的就不要强求了。这本书的好处就是看面经的时候说道的算法基本上就都见过名字了。
...
木有竞赛经历，木有pape。有过百度做测试的经历，事实证明没人care。做过一个浏览器的项目，事实证明除了遨游别的公司要么不care要么听不懂。做了个博客一方面是个加分另一方面也给自己挖了个坑一会儿再说。兴趣十分广泛，已经被多个面试官肯定了，什么都能接一句，但是没有啥特长的基本都接不过三句。
